<nav class="navbar navbar-light navbar-expand-lg navigation-clean" style="font-family: Aldrich, sans-serif; font-size: 16px;">
    <div class="container"><a class="navbar-brand" href="/index"><img class="img-fluid" src="http://sadventure.xf.cz/public/images/android-chrome-256x256.png" alt="brand" style="width: 60px;height: 60px;"></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="nav navbar-nav text-center mx-auto">
                ...
                <li class="dropdown nav-item"><a class="dropdown-toggle nav-link text-capitalize text-center" data-bs-toggle="dropdown" aria-expanded="true" href="#">Isama</a>
                ...
                <li class="dropdown nav-item"><a class="dropdown-toggle nav-link text-capitalize text-center" data-bs-toggle="dropdown" aria-expanded="true" href="#">Ostatní</a>
        ...
        <ul class="nav navbar-nav ml-auto">
            <li class="nav-item dropdown"><a data-bs-toggle="dropdown" aria-expanded="true" class="dropdown-toggle nav-link" href="#"><img src="http://sadventure.xf.cz/public/images/avatars/{{$member->avatar}}" alt="img" height="60px" style="padding-right: 10px;" />{{$member->username}}</a>
